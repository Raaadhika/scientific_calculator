...
btnexmp1 =  Button(calc , text="exmp1", width =6, height=2 ,font=('arial',20,'bold'),bd=4,bg="powder blue",
...
# Add commands to the File menu
editmenu.add_command(label="cut", command=lambda: tkinter.messagebox.showinfo("Mode", "Cut"))
editmenu.add_command(label="copy", command=lambda: tkinter.messagebox.showinfo("Mode", "Copy"))
...
# Add commands to the File menu
helpmenu.add_command(label="View Help", command=lambda: tkinter.messagebox.showinfo("Mode", "Help"))
